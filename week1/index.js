...
console.log(`alexAge:${alexAge}, alexMembershipID:${alexMembershipID},  isRunningOnTreadmill:${alexMembershipID},`)
...
const groupYoga = 300;
const groupRetrain = 500;
const personalRetrain = 1500;
...
// 買3堂瑜伽團課 + 3堂重訓團課
AlexBudget = AlexBudget - 3*groupYoga - 3*groupRetrain;
...
let price = 2520;
let courseTime = 50;
let argCourse = prize/courseTotal;
let discount = 0.9;
...
let groupClassesTotal = 2*groupClass;
...
a = 13; // 變更變數a的值為13
a = b + 4; // 變更變數a的值為 變數b +4 = 0+4 = 4
a - b; // 純計算 變數a - 變數b = 4 - 0 = 4
b += 1; // 變更變數b的值為 變數b +1 = 0 + 1 = 1
...
let numberArr1 = [5, 10, 15]; // 宣告了一個 numberArr1 的數字型別陣列
let numberArr2 = numberArr1; // 宣告了一個 numberArr2 的陣列，並指向numberArr1位置
numberArr2.push(20); // 將numberArr2最後加入20 => 同時也表示numberArr1最後也會加上20
numberArr2 = [25, 30, 35]; // 重新定義numberArr2為新的陣列
